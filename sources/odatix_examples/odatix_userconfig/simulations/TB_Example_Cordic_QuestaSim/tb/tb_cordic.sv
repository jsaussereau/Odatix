...
// **********************************************************************
//
// Testbench for the pipelined CORDIC rotation core (ModelSim / QuestaSim).
//
// This testbench is language agnostic: it drives the "cordic" design through
// its ports only, so it works with both the VHDL and the SystemVerilog
// version of the core. The mixed language support of ModelSim/QuestaSim maps
// the parameters below to the generics of the VHDL entity, and its ports to
// the std_logic_vector ports of the entity.
//
...
//
// WIDTH and ITERATIONS are passed by scripts/sim.do, which reads them back
// from the RTL file configured by Odatix and forwards them to the elaboration
// of this testbench (vsim -gWIDTH=... -gITERATIONS=...).
