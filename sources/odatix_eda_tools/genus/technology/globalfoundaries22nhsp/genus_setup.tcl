...
set LIB_ROOT \
    /asic/ip/DesignWare_logic_libs/globalfoundaries22nhsp/32hd116/hdl/lvt/2.00a

set LIB_PATH \
    $LIB_ROOT/liberty/logic_synth_lvf
...
# Example metal stack
set TECH_LEF_PATH \
    $PDK_PATH/PlaceRoute/Innovus/Techfiles/10M_2Mx_4Cx_2Bx_2Jx_LB
...
lappend LIBS \
    gf22nspllogl32hdl116f_SSG_0P72V_0P00V_0P60V_M1P00V_125C.lib.gz
...
lappend LEFS \
    $TECH_LEF_PATH/22FDSOI_10M_2Mx_4Cx_2Bx_2Jx_LB_116cpp_tech.lef

# Standard placement-site definitions
lappend LEFS \
    $PDK_PATH/PlaceRoute/Innovus/Techfiles/22fdsoi_standard_site.lef

# Standard-cell physical library
lappend LEFS \
    $CELL_LEF_PATH/gf22nspllogl32hdl116f.lef
