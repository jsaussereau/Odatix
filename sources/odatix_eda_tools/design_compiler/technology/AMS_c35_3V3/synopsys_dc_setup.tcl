...
#########
set AMSDIR [get_unix_variable AMS_C35_3V3]
set SYNDIR [get_unix_variable SYNOPSYS]

#########
### set library paths
#########
set search_path	". $AMSDIR /opt/ams/synopsys/c35_3.3V /softs/kits/ams/AMS_410_CDS/synopsys/c35_3.3V/ $SYNDIR/libraries/syn $SYNDIR/dw/sim_ver ../rtl ./db ./"
