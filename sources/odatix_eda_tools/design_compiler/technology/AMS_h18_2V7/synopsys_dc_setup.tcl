...
#########
set AMSDIR [get_unix_variable AMS_H18_2V7]
set SYNDIR [get_unix_variable SYNOPSYS]

#########
### set library paths
#########
set search_path	". $AMSDIR /opt/ams/synopsys/h18_2.7V /softs/kits/ams/AMS_411_CDS/synopsys/h18_2.7V/ $SYNDIR/libraries/syn $SYNDIR/dw/sim_ver ../rtl ./db ./"
