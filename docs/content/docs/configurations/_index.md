...
| **[Parameter domains](/docs/configurations/param_domains/)** | Independent groups of parameters combined with `+` and `*`. | Parameters are independent (memory depth, ISA extensions, multiplier type…). |
